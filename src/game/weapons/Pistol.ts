 ...
 */
export class Pistol implements IWeaponStrategy {
  readonly name = 'Pistol';
  readonly fireRate = 1.33;     // ~1.33 shots/sec (3x slower: was 4)
  readonly damage = 40;         // 2x damage (was 20)
  readonly maxAmmo = Infinity;
